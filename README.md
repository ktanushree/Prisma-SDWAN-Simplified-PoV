...
| ------- | ----- | ------- |
| **1.0.0** | **b15** | BYOS: SDK version check during security zone creation |
|           | **b14** | Included performance policy, BYOS changes - unused interfaces admin down, default static routes, default rule transits DC |
|           | **b13** | Fixed naming convention for policies, LAN zone binding and DC naming convention |
